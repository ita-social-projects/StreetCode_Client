...
const TransactionLinksApi = {
    ...
    create: (transactionLink: TransactionLink) => Agent.post<TransactionLink>(`${API_ROUTES.TRANSACTION_LINKS.CREATE}`, transactionLink),

    update: (transactionLink: TransactionLink) => Agent.put<TransactionLink>(`${API_ROUTES.TRANSACTION_LINKS.UPDATE}`, transactionLink),
