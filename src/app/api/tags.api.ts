...
const TagsApi = {
    ...
    getTagsByStreetcodeId: (streetcodeId: number) => Agent.get<Tag>(`${API_ROUTES.TAGS.GET_BY_STREETCODE_ID}/${streetcodeId}`),

    create: (tag: Tag) => Agent.post<Tag>(`${API_ROUTES.TAGS.CREATE}`, tag),
