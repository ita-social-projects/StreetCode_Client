...
export const ERROR_PHOTO_VIEW = 'Помилка при перегляді фото';
export const FAILED_TO_UPDATE_HISTORYCODE = 'Виникла помилка при оновленні history-коду';
export const FAILED_TO_CREATE_HISTORYCODE = 'Виникла помилка при створенні history-коду';
...
export const ERROR_MESSAGES = {
    ...
    TEAM_MEMBER_COULD_NOT_LOAD,
    PARTNER_COULD_NOT_LOAD,
    NEWS_COULD_NOT_LOAD,
    ERROR_PHOTO_VIEW,
    FAILED_TO_UPDATE_HISTORYCODE,
    FAILED_TO_CREATE_HISTORYCODE,
};
