    ...
    <div className="aboutUsHeaderContainer">
        ...
        <div className='contentWrapper'>
            <div className='headerBigText'>
                Привіт! Ми – ГО <text className='redText'>«Історична Платформа»</text>, що разом із командою досвідчених креаторів, провідних істориків та потужних партнерів створює «Стріткод» – найбільшу платформу про історію України, вбудовану в простори міст.
            </div>
