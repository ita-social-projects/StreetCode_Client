...
, що разом із командою досвідчених креаторів,
                провідних істориків та потужних партнерів створює «Стріткод» — найбільшу платформу про історію України,
                вбудовану в простори міст.
            </div>
            ...
            <div className="headerList">
                ...
                <div className="listItem">
                    <div className="redLine" />
                    <div className="listText">
                        Посилюємо історичну просвіту, популяризуємо історію, допомагаємо з декомунізацією історичної
                        свідомості.
                    </div>
                </div>
            </div>
            ...
            <div className="headerSmallText">
                Все це верифіковано, концентровано, структуровано та в одному місці. Щоб нарешті позбутися
                колонізаторських впливів та наслідків.
            </div>
        </div>
    </div>
);
