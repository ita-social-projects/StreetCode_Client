    ...
    <div className="aboutUsBlockContainer">
        ...
        <div className="contentWrapper">
            <div className="headerBigText">
                Привіт! Ми — ГО
                {' '}
                <label className="redText">«Історична Платформа»</label>, що разом із командою досвідчених креаторів, провідних істориків та потужних партнерів створює «Стріткод» — найбільшу платформу про історію України, вбудовану в простори міст.
            </div>
