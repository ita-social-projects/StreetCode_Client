    ...
    return (
        <div className="catalogPage">
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Ознайомтеся з нашим повним каталогом history-кодів."
                />
            </Helmet>
            <div className="streetcodeCatalogWrapper">
                <div className="streetcodeHeadingContainer">
                    <div className="headingFlexItem">
                        <h1 className="streetcodeCatalogHeading">
                            History-коди
                        </h1>
                    </div>
                    <div className="headingFlexItem">
                        <p className="streetcodeCatalogCaption">HISTORY-КОДИ</p>
                    </div>
                </div>
                <div className="steetcodeCatalogContainer">
                    {getCatalogStreetcodesArray.map((streetcode, index) => (
                        <StreetcodeCatalogItem
                            key={streetcode.id}
                            streetcode={streetcode}
                            isLast={
                                index === getCatalogStreetcodesArray.length - 1
                            }
