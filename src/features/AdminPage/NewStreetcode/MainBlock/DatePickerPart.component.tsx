...
const DatePickerPart = React.memo(
  ({ setFirstDate, setSecondDate, form, onChange }: Props) => {
    const [firstDateTimePickerType, setFirstDateTimePickerType] =
      useState<DatePickerType>(DatePickerType.Date);
    const [secondDateTimePickerType, setSecondDateTimePickerType] =
      useState<DatePickerType>(DatePickerType.Date);
    ...
    const customFormat: (
      ...
      } else if (dateTimePicker === DatePickerType.Year) {
            ...
            <div className="date-picker-group-item">
              ...
              <FormItem name="streetcodeSecondDate" className="my-picker">
                <DatePicker
                  ...
                  format={(date) =>
                    customFormat(date, secondDateTimePickerType)
                  }
                  placeholder={
