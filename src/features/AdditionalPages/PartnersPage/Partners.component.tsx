...
const PartnersPage = () => (
    <>
        <Helmet>
            ...
            <meta
                name="description"
                content="Дізнайтеся про наших цінних партнерів, що вклали внесок у нашу місію."
            />
        </Helmet>
        <div className="partnersContainer">
            <div className="wrapper">
                ...
                <div className="subTitle titleBottom">
                    Тобі чи твоїй компанії відгукується наш проєкт? Наперед
                    тиснемо руку та мріємо про спільну залученість. Приєднуйся!
                </div>
