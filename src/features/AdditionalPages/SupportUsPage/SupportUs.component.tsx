...
const SupportUs = () => {
    ...
    return (
        <div className="supportUsPage">
            <Helmet>
                <title>Підтримати нас | Historycode</title>
            ...
            <div className="supportUsPageWrapper">
                <div className="heading">
                    ...
                    <div className="text">
                        Наша команда горить—палає місією «за-history-кодити всю Україну», розповісти про видатних Героїв та подати цікавенні факти з історії.
                ...
                <div className="mainBlock">
                    <div className="donatesPurposeBlock">
                        ...
                        <ul className="purposeList">
                            <li>
                                <Printer />
                                <span>для друку наших промовистих history-кодів—табличок</span>
                            </li>
                            <li>
                                <CreditCard />
                        ...
                        <div className="purposeBottomText">
                            <p>
                                ...
                                та підтримаєш унікальну платформу «Historycode». Де є про все: світло історії, велич Героїв
                            ...
                            <p>
                                ...
                                в міських просторах. З історії ми знаємо, що світ не без добрих людей, а Historycode — не без
                ...
                <div className="donateSubBlocks">
                    ...
                    <div className="block forCompanies">
                        ...
                        <div className="content">
                            <p>
                                Сконтактуй з нашою командою щодо History-код—партнерства та внесків на
