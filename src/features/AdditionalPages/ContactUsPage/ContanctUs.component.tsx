...
const ContactUs = () => (
    <div className="contactUsContainer">
        <Helmet>
            ...
            <meta
                name="description"
                content="Зв’яжіться з нами для будь-яких запитань, відгуків або підтримки."
            />
        </Helmet>
        <div className="contactUsCover">
            <div className="wrapper">
                ...
                <div className="contactUsContent">
                    ...
                    <br />
                    <h3>
                        Пройди, будь ласка, коротеньке опитування, вкажи нам про
                        всі зручності/незручності, баги/спотикачки і що ще тобі
                        муляє. Це допоможе нам зробити сайт максимально
                        user-friendly!
                    </h3>
                    <br />
                    <h3>
                        Зазнач в опитуванні електронну пошту, і ми подякуємо
                        тобі креативним стікерпаком для сториз!
                    </h3>
                    <br />
                    <Button
