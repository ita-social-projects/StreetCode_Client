...
export class ClientController {
  ...
  private async loadStreetcodes() {
    try {
      const allStreetcoderesponse = await this.streetcodeService.getAllStreetcodes();

      allStreetcoderesponse.data.streetcodes.forEach(streetcode => {
        this.streetcodeService.getImagesOfStreetcode(streetcode.id).then(data => {
